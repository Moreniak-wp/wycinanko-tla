...
const STRINGS = {
    POPUP: {
        ...
        SETTINGS_MANAGE_RULES: 'Zarządzaj własnymi regułami', 
        SETTINGS_RESET_CUSTOM_RULES: 'Resetuj wszystkie własne reguły',
        ...
        RULES_VIEW_HEADER: 'Moje reguły', 
        RULES_VIEW_EMPTY: 'Brak własnych reguł. Użyj narzędzia "Wybierz element", aby dodać nowe.', 
        RULES_VIEW_DELETE_RULE: 'Usuń', 
        LOADING: 'Ładowanie...',
        ...
        STATUS_RULE_DELETED: 'Reguła została usunięta.', 
