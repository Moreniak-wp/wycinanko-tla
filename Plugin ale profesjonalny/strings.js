const STRINGS = {
    POPUP: {
        ...
        TOGGLE_ENABLED: 'Wyłącz Plugin',
        TOGGLE_DISABLED: 'Włącz Plugin',
        WHITELIST_ADD: 'dodaj do white listy',
        WHITELIST_REMOVE: 'usuń z white listy',
        WHITELIST_NOT_APPLICABLE: 'whitelista nie dotyczy tej strony',
        SETTINGS_SHOW: 'druga strona',
        SETTINGS_PICK_ELEMENT: 'usuń element ręcznie',
        SETTINGS_RESET_CUSTOM_RULES: 'resetuj elementy usunięte ręcznie',
        SETTINGS_RESET_COUNTER: 'resetuj licznik reklam',
        SETTINGS_DOWNLOAD_LOGS: 'Pobierz logi',
        SETTINGS_CLEAR_LOGS: 'Wyczyść logi',
        SETTINGS_BACK: 'Główna strona',
        LOADING: 'Ładowanie',
        WHITELIST_BUTTON_DEFAULT: 'Whitelist',
        STATUS_PICKER_UNAVAILABLE: "nie można użyć pickera",
